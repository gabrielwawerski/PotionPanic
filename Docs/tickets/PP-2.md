...
- [ ] `Assets/Scenes/Laboratory.unity` is the shared gameplay scene, and project scene
  defaults no longer point at `SampleScene.unity`.
- [ ] The scene contains a static orthographic main camera and a one-room lab blockout
