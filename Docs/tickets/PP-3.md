...
inside `Laboratory.unity`. Keep the scope to world-aligned movement only: no look, sprint, jump, gravity gameplay, camera-relative movement, interaction, or input-asset redesign.
