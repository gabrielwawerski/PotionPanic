...
- [Evergreen Documentation V2](evergreen-documentation-v2.md)

Use the [active plans index](../plans/) for intended work and the
[Documentation Atlas](../ATLAS.md) for current project guidance.
