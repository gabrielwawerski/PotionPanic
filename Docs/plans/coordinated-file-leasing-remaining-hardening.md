...
- [ ] **Step 5: Commit the guidance.**
  ...
  ```powershell
  git add Tools/CoordinationServer/README.md README.md Docs/onboarding/getting-started.md Docs/collaboration/team-workflow.md Docs/guides/unity/editor-safety.md
