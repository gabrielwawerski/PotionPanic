...
- Create the Coordination window, view-model, notifications, and lifecycle
  bootstrap files under `Assets/Scripts/Editor/Coordination/`.
...
**Handoff:** Record UI and lifecycle evidence in `PP-7`. Slice 09 is the only
remaining session and may deploy, use real credentials, and update evergreen
documentation.
