...
Completed, superseded, or historical implementation plans live here. Keep active
implementation work in [`../index.md`](../index.md).
...
## Docboard And VitePress

- [VitePress Project Management Feature Proposals](./vitepress-project-management-feature-proposals.md)
- [Archived Plan Restore](./vitepress-archived-plan-restore.md)
- [Restore
  `TagEditor` As The Editable Tags UI With Tag Color Editing](./vitepress-tag-editor-restore-plan.md)
...
- [VitePress Live Sidebar Updates During
  `docs:dev`](./vitepress-live-sidebar-updates-2026-06-29.md)
- [VitePress Board UX Plans](./vitepress-board-ux-plans.md)
- [VitePress Theme Review](./vitepress-theme-review-2026-06-28.md)
