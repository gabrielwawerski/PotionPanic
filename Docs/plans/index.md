...
This section holds active implementation plans that need more room than a ticket
body but should still stay visible in the VitePress site while the work is in
progress.
...
- Docboard regenerates the Active Plans links from each plan's frontmatter title
  or first heading. Keep those links title-only.
